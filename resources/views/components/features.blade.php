<section>
    <div class="flex justify-between">
        <!-- Image for medium and above -->
        <div class="hidden lg:block w-1/2 flex-shrink-0 mr-12 lg:mr-16 bg-cover bg-center bg-no-repeat rounded-3xl"
            style="background-image: url('/storage/img/features-kitchen.jpg');">
        </div>

        <!-- Image for medium and below -->
        <div class="hidden sm:block lg:hidden w-1/2 flex-shrink-0 mr-12 bg-cover bg-center bg-no-repeat rounded-3xl"
            style="background-image: url('/storage/img/rec2.jpg');">
        </div>
