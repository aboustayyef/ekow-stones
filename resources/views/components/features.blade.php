<section>
    <div class="md:flex justify-between">
        <div class="hidden md:block w-1/2 flex-shrink-0 mr-12 lg:mr-16 bg-cover bg-center bg-no-repeat rounded-3xl" style="background-image: url('/storage/img/unsplash-kitchen-homepage.jpg');"> </div>
        <div class="text-center md:text-left w-full featureList">
